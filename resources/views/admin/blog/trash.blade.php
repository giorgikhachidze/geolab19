        ...
        <div class="col-md-12">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">წაშლილი პოსტები</h3>
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($posts as $post)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('admin.blog.trashStore', $post->id) }}" method="POST">
                                        @csrf
                                        <button type="submit" class="btn btn-block btn-success btn-xs">აღდგენა</button>
                                    </form>
                                </td>
                                <td>
                                    <form action="{{ route('admin.blog.trashDestroy', $post->id) }}" method="POST">
                                        @csrf
